...
export default function Index() {
    ...
    return (
        <View className="flex-1 flex justify-end bg-[#7FC241]">
            ...
            >
                ...
                <Animated.View entering={FadeInDown.delay(200).springify()}>
                    <TouchableOpacity
                        ...
                        className="bg-[#7FC241] flex items-center justify-center mx-auto rounded-full border-[2px] border-neutral-200"
                    >
